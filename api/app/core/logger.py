...
from app.domain.errors import ApiException
...
class Log:
    ...
    def __init__(self, config: dict, name: str = ""):
        ...
        self.__level = getLevelName(config["log"]["level"].upper())
        self.__is_base = True
    ...
    def exception(self, err: Exception | BaseException):
        log = self.__duplicate__()
    ...
    def success(self, msg: str | None = None):
    ...
    def error(self, msg: str | None = None, error: Exception | BaseException | None = None):
        """
    ...
    def warning(self, msg: str | None = None, error: Exception | BaseException | None = None):
        """
    ...
    def __msg(self) -> str:
        ...
        return json.dumps(data, sort_keys=True, default=default_json_serializer)
